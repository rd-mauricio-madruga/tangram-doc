"use strict";(self.webpackChunkdocs=self.webpackChunkdocs||[]).push([[8611],{54479:(e,t,r)=>{r.d(t,{D:()=>u,Z:()=>s});var n=r(25773),a=r(27378),i=r(67468),o=r(45666);const l=i.ZP.div`
...
`,q=(0,a.forwardRef)(((e,t)=>{let{range:r,className:i,titleAction:o,placeholder:l,position:u=q.positions.bottom,selected:p=null,locale:m=c.Z,double:h=!1,yearlyView:g=!1,inline:v=!1,startDate:f=null,endDate:y=null,onChange:b=(()=>{}),dateFormat:w="dd/MM/yyyy",width:Z,customInput:k,inlineEdit:E=!1,error:_=!1,suffix:z,inlineActions:C,disabled:R,...S}=e;(0,s.registerLocale)("locale",m);const A=(0,a.useRef)(t),[T,I]=(0,a.useState)(!1),$=(0,a.useRef)(!0),D=(0,a.useRef)(),N=(0,a.useRef)(),P=(0,a.useRef)(),L=h?2:1;(0,a.useLayoutEffect)((()=>{if($.current)return D.current=p,N.current=f,P.current=y,void($.current=!1);const e=D.current&&!p,t=N.current&&!f,r=P.current&&!y;if(!A.current?.calendar?.componentNode)return;if(e||t||r){A.current.calendar.componentNode.querySelectorAll(".react-datepicker__day--selected, .react-datepicker__day--keyboard-selected").forEach((e=>{e.classList.remove("react-datepicker__day--selected"),e.classList.remove("react-datepicker__day--keyboard-selected")}))}const n=A.current.calendar.componentNode.querySelector(".react-datepicker__day--keyboard-selected"),a=A.current.calendar.componentNode.querySelector(".react-datepicker__day--selected");n&&a&&(n.classList.remove("react-datepicker__day--keyboard-selected"),a.classList.add("react-datepicker__day--keyboard-selected")),D.current=p,N.current=f,P.current=y}),[p,f,y,v]),(0,a.useLayoutEffect)((()=>{if(g&&(T||v)){if(!A.current?.calendar?.componentNode)return;const e=Array.from(A.current.calendar.componentNode.querySelectorAll(".react-datepicker__month-text"));A.current.calendar.componentNode.querySelectorAll(".react-datepicker__month-wrapper").forEach((t=>{const r=e.splice(0,4);if(r.length)return r.map((e=>t.appendChild(e)));t.style.display="none"}))}}),[g,T,v]);const O=(0,a.isValidElement)(k)?(0,a.cloneElement)(k,{calendarOpen:T}):k;return a.createElement(j,{$monthsShown:h,$yearlyView:g,className:i,$inline:v,$width:Z,"data-tg-inline-edit":E?"true":void 0,"data-tg-error":E&&_?"true":void 0,"data-tg-calendar-open":T?"true":void 0,"aria-disabled":!!R||void 0},a.createElement(d(),(0,n.Z)({selected:p,onCalendarClose:()=>I(!1),onCalendarOpen:()=>I(!0),renderCustomHeader:e=>(e=>g?a.createElement(x,(0,n.Z)({locale:m},e)):a.createElement(M,(0,n.Z)({titleAction:o,monthsShown:L,locale:m},e)))(e),locale:"locale",monthsShown:L,popperPlacement:u,showPopperArrow:!1,showMonthYearPicker:g,inline:v,ref:A,placeholderText:l,startDate:f,endDate:y,onChange:b,dateFormat:w,customInput:O,disabled:R},S)))}));q.displayName="DatePickerBase",q.positions={top:"top-start",bottom:"bottom-start"},q.propTypes={position:o().oneOf([q.positions.top,q.positions.bottom]),selected:o().instanceOf(Date),startDate:o().instanceOf(Date),endDate:o().instanceOf(Date),inline:o().bool,onChange:o().func,locale:o().object,dateFormat:o().string,double:o().bool,yearlyView:o().bool,titleAction:o().func,placeholder:o().string};const B=q},81583:(e,t,r)=>{r.d(t,{Z:()=>R});var n=r(25773),a=r(27378),i=r(23615),o=r.n(i),l=r(67468),s=r(51288),d=r(38095),c=r(75387),u=r(61380),p=r(55575),m=r(67425),h=r(3859),g=r(73647),v=r(41703),f=r(2793),y=r(15294);const b={IconButton:{props:{kind:"neutral",size:"sm"}}},w=(0,l.ZP)(d.Z).attrs({gap:1,verticalAlign:d.Z.verticalAlignments.center})`
  ${c.Z.Style} {
    ${c.Z.SmallStyle}
