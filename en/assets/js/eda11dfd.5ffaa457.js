"use strict";(self.webpackChunkdocs=self.webpackChunkdocs||[]).push([[4659],{54479:(e,t,a)=>{a.d(t,{D:()=>u,Z:()=>s});var r=a(25773),i=a(27378),n=a(67468),o=a(45666);const l=n.ZP.div`
...
`,w=(0,l.ZP)(p.Z)`
  ...
  left: 0;
  width: 280px;
`,Z=(0,i.forwardRef)(((e,t)=>{let{locale:a=c.Z,...n}=e;const{date:o,changeYear:l}=n;let s=o;return i.createElement(f,(0,r.Z)({ref:t},n),i.createElement(b,null,i.createElement(y,{kind:m.Z.kinds.tertiary,size:h.Z.sizes.sm,onClick:()=>l((0,u.default)(s)-1),"aria-controls":"headerNavigation"},i.createElement(g.Z,{id:"previous-year",title:"go to previous year",titleId:"previous-year"})),i.createElement(w,{id:"headerNavigation","aria-live":"assertive"},(0,u.default)(s)),i.createElement(y,{kind:m.Z.kinds.tertiary,size:h.Z.sizes.sm,onClick:()=>l((0,u.default)(s)+1),"aria-controls":"headerNavigation"},i.createElement(v.Z,{id:"next-year",title:"go to next year",titleId:"next-year"}))))}));Z.displayName="DatePicker.YearlyHeader",Z.propTypes={locale:o().object};const x=Z;var k=a(54571),z=a(64083),_=a(87926),E=a(37811),C=a(17752),$=a(5662),P=a(50046),T=a(38095),I=a(2793);const N="48px",R=l.ZP.div`
  display: flex;
  justify-content: space-between;
  position: absolute;
  width: calc(100% - (var(--size-spacing-04) * 2));
...
`,L=(0,i.forwardRef)(((e,t)=>{let{locale:a=c.Z,...n}=e;const{monthsShown:o,date:l,decreaseMonth:s,increaseMonth:d,prevMonthButtonDisabled:f,nextMonthButtonDisabled:b,titleAction:y}=n,w=!P.Z(y)&&{forwardedAs:"div",tabindex:"-1"},Z=Array(o).fill(0);let x=document.getElementsByClassName("react-datepicker__month"),N=l;if(o>1&&x.length){const e=x[0].getAttribute("aria-label").replace("month","").trim().split("-").join("/");N=new Date(`${e}/01`)}return i.createElement(R,(0,r.Z)({ref:t},n),i.createElement(S,null,i.createElement(D,{kind:m.Z.kinds.tertiary,onClick:s,disabled:f,"aria-controls":"headerNavigation"},i.createElement(g.Z,{id:"previous-month",title:"go to previous month",titleId:"previous-month"})),i.createElement(T.Z,{id:"headerNavigation","aria-live":"assertive"},Z.map(((e,t)=>i.createElement(A,(0,r.Z)({key:`header-${t}`,second:!!t,token:p.Z.tokens.TEXT_MD_BOLD,onClick:y,kind:h.Z.kinds.tertiary,size:h.Z.sizes.md},w),`${(0,I.G4)(a)[(0,E.default)((0,_.default)(N,t))]} ${(0,u.default)(N)}`)))),i.createElement(D,{kind:m.Z.kinds.tertiary,onClick:d,disabled:b,"aria-controls":"headerNavigation"},i.createElement(v.Z,{id:"next-month",title:"go to next month",titleId:"next-month"}))),i.createElement(S,null,Z.map(((e,t)=>i.createElement(M,{as:$.Z.as.ul,key:`weekdays-${t}`},((e,t)=>{const a=(0,k.default)(t,{locale:e});return[].concat([0,1,2,3,4,5,6].map((t=>{const r=(0,z.default)(a,t),n=e.localize.day((0,C.default)(r),{width:"short"});return i.createElement("li",{key:t,className:"react-datepicker__day-name"},n)})))})(a,(0,_.default)(N,t)))))))}));L.displayName="DatePicker.MonthlyHeader",L.propTypes={locale:o().object,titleAction:o().func};const O=L,j="40px",F=l.ZP.div`
...
`,H=(0,i.forwardRef)(((e,t)=>{let{range:a,className:n,titleAction:o,placeholder:l,position:u=H.positions.bottom,selected:m=null,locale:p=c.Z,double:h=!1,yearlyView:g=!1,inline:v=!1,startDate:f=null,endDate:b=null,onChange:y=(()=>{}),dateFormat:w="dd/MM/yyyy",width:Z,customInput:k,inlineEdit:z=!1,error:_=!1,suffix:E,disabled:C,...$}=e;(0,s.registerLocale)("locale",p);const P=(0,i.useRef)(t),[T,I]=(0,i.useState)(!1),N=(0,i.useRef)(!0),R=(0,i.useRef)(),S=(0,i.useRef)(),D=(0,i.useRef)(),A=h?2:1;(0,i.useLayoutEffect)((()=>{if(N.current)return R.current=m,S.current=f,D.current=b,void(N.current=!1);const e=R.current&&!m,t=S.current&&!f,a=D.current&&!b;if(!P.current?.calendar?.componentNode)return;if(e||t||a){P.current.calendar.componentNode.querySelectorAll(".react-datepicker__day--selected, .react-datepicker__day--keyboard-selected").forEach((e=>{e.classList.remove("react-datepicker__day--selected"),e.classList.remove("react-datepicker__day--keyboard-selected")}))}const r=P.current.calendar.componentNode.querySelector(".react-datepicker__day--keyboard-selected"),i=P.current.calendar.componentNode.querySelector(".react-datepicker__day--selected");r&&i&&(r.classList.remove("react-datepicker__day--keyboard-selected"),i.classList.add("react-datepicker__day--keyboard-selected")),R.current=m,S.current=f,D.current=b}),[m,f,b,v]),(0,i.useLayoutEffect)((()=>{if(g&&(T||v)){if(!P.current?.calendar?.componentNode)return;const e=Array.from(P.current.calendar.componentNode.querySelectorAll(".react-datepicker__month-text"));P.current.calendar.componentNode.querySelectorAll(".react-datepicker__month-wrapper").forEach((t=>{const a=e.splice(0,4);if(a.length)return a.map((e=>t.appendChild(e)));t.style.display="none"}))}}),[g,T,v]);const M=(0,i.isValidElement)(k)?(0,i.cloneElement)(k,{calendarOpen:T}):k;return i.createElement(F,{$monthsShown:h,$yearlyView:g,className:n,$inline:v,$width:Z,"data-tg-inline-edit":z?"true":void 0,"data-tg-error":z&&_?"true":void 0,"data-tg-calendar-open":T?"true":void 0,"aria-disabled":!!C||void 0},i.createElement(d(),(0,r.Z)({selected:m,onCalendarClose:()=>I(!1),onCalendarOpen:()=>I(!0),renderCustomHeader:e=>(e=>g?i.createElement(x,(0,r.Z)({locale:p},e)):i.createElement(O,(0,r.Z)({titleAction:o,monthsShown:A,locale:p},e)))(e),locale:"locale",monthsShown:A,popperPlacement:u,showPopperArrow:!1,showMonthYearPicker:g,inline:v,ref:P,placeholderText:l,startDate:f,endDate:b,onChange:y,dateFormat:w,customInput:M,disabled:C},$)))}));H.displayName="DatePickerBase",H.positions={top:"top-start",bottom:"bottom-start"},H.propTypes={position:o().oneOf([H.positions.top,H.positions.bottom]),selected:o().instanceOf(Date),startDate:o().instanceOf(Date),endDate:o().instanceOf(Date),inline:o().bool,onChange:o().func,locale:o().object,dateFormat:o().string,double:o().bool,yearlyView:o().bool,titleAction:o().func,placeholder:o().string};const q=H},81583:(e,t,a)=>{a.d(t,{Z:()=>$});var r=a(25773),i=a(27378),n=a(23615),o=a.n(n),l=a(67468),s=a(51288),d=a(38095),c=a(75387),u=a(61380),m=a(55575),p=a(67425),h=a(3859),g=a(73647),v=a(41703),f=a(2793),b=a(15294);const y={IconButton:{props:{kind:"neutral",size:"sm"}}},w=(0,l.ZP)(d.Z).attrs({gap:1,verticalAlign:d.Z.verticalAlignments.center})`
  ${c.Z.Style} {
    ${c.Z.SmallStyle}
...
`;function z(e){e.stopPropagation()}function _(){return i.createElement(v.Z,{title:"Datepicker",titleId:"datepicker-input"})}function E(e){let{children:t}=e;return t?i.createElement(w,{onMouseDown:z,onClick:z},i.createElement(p.Z,{spec:y},t)):null}const C=(0,i.forwardRef)(((e,t)=>{let{value:a,className:n,startDate:o="",endDate:l="",onStartChange:d=(()=>{}),onEndChange:c=(()=>{}),onChange:u=(()=>{}),firstInputRef:m=null,secondInputRef:p=null,dateFormat:v="dd/MM/yyyy",locale:b=s.Z,double:y=!1,inlineEdit:w=!1,error:z=!1,suffix:C,calendarOpen:$=!1,onFocus:P,onBlur:T,...I}=e;const[N,R]=(0,i.useState)(o),[S,D]=(0,i.useState)(l),A=(0,i.useRef)(null),M=(0,i.useRef)(null),{keyboardFocusAttr:L,onTabFocusCapture:O,onTabBlurCapture:j}=function(e){const[t,a]=(0,i.useState)(!1),r=(0,i.useRef)(!1);return(0,i.useEffect)((()=>{if(e)return document.addEventListener("keydown",t,!0),document.addEventListener("mousedown",i,!0),()=>{document.removeEventListener("keydown",t,!0),document.removeEventListener("mousedown",i,!0)};function t(e){"Tab"===e.key&&(r.current=!0)}function i(){r.current=!1,a(!1)}a(!1)}),[e]),{keyboardFocusAttr:t?"true":void 0,onTabFocusCapture(){a(r.current)},onTabBlurCapture(){a(!1)}}}(w);(0,i.useEffect)((()=>{R(o)}),[o]),(0,i.useEffect)((()=>{D(l)}),[l]);const F=e=>{O(),P?.(e)},H=e=>{j(),T?.(e)},q=C?i.createElement(E,null,C):void 0,B=$?"true":void 0,V={onChange:e=>{const t=!h.Z(e.target.value,v.length);g.Z(e.target,[A.current])&&(R(e.target.value),t&&(d((0,f.sG)(e.target.value,v,b)),u(e))),g.Z(e.target,[M.current])&&(D(e.target.value),t&&(c((0,f.sG)(e.target.value,v,b)),u(e)))},onFocus:F,onBlur:H};return i.createElement(k,{className:y?n:void 0,ref:y?t:void 0,"data-tg-keyboard-focus":y?L:void 0},y?i.createElement(i.Fragment,null,i.createElement(Z,(0,r.Z)({prefix:_(),rootRef:A,ref:m,className:"range-start datepicker-input",type:"text",value:N},I,V)),i.createElement(x,null,"-"),i.createElement(Z,(0,r.Z)({rootRef:M,ref:p,className:"range-end datepicker-input",type:"text",value:S},I,V)),q):i.createElement(Z,(0,r.Z)({prefix:_(),value:a,onChange:u,className:`datepicker-input ${n||""}`,inlineEdit:w,error:z,suffix:q,"data-tg-calendar-open":B,"data-tg-keyboard-focus":L},I,{onFocus:F,onBlur:H,ref:t})))}));C.displayName="DatePickerInput",C.Style=k,C.propTypes={placeholder:o().string,startDate:o().string,endDate:o().string,onStartChange:o().func,onEndChange:o().func,locale:o().object,dateFormat:o().string,double:o().bool,inlineEdit:o().bool,error:o().bool,suffix:o().node,firstInputRef:o().oneOfType([o().func,o().shape({current:o().any})]),secondInputRef:o().oneOfType([o().func,o().shape({current:o().any})])};const $=C},15294:(e,t,a)=>{a.d(t,{L:()=>o,N:()=>n});var r=a(67468),i=a(61380);const n=":not([aria-disabled='true']):not(:has(input[readonly])):not(:has(textarea[readonly]))",o=r.iv`
