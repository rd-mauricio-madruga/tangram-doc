...
`,w=(0,l.ZP)(p.Z)`
  ...
  left: 0;
  width: 280px;
`,Z=(0,n.forwardRef)(((e,t)=>{let{locale:a=c.Z,...i}=e;const{date:o,changeYear:l}=i;let s=o;return n.createElement(f,(0,r.Z)({ref:t},i),n.createElement(b,null,n.createElement(y,{kind:m.Z.kinds.tertiary,size:h.Z.sizes.sm,onClick:()=>l((0,u.default)(s)-1),"aria-controls":"headerNavigation"},n.createElement(g.Z,{id:"previous-year",title:"go to previous year",titleId:"previous-year"})),n.createElement(w,{id:"headerNavigation","aria-live":"assertive"},(0,u.default)(s)),n.createElement(y,{kind:m.Z.kinds.tertiary,size:h.Z.sizes.sm,onClick:()=>l((0,u.default)(s)+1),"aria-controls":"headerNavigation"},n.createElement(v.Z,{id:"next-year",title:"go to next year",titleId:"next-year"}))))}));Z.displayName="DatePicker.YearlyHeader",Z.propTypes={locale:o().object};const x=Z;var k=a(54571),z=a(64083),_=a(87926),E=a(37811),C=a(17752),$=a(5662),P=a(50046),T=a(38095),I=a(2793);const R="48px",N=l.ZP.div`
  display: flex;
  justify-content: space-between;
  position: absolute;
  width: calc(100% - (var(--size-spacing-04) * 2));
...
`,A=(0,l.ZP)(h.Z)`
  ...
  width: calc(
    ${"312px"} - 2 * ${R} - (2 * var(--size-spacing-04))
  );
  padding: 0;
  margin-bottom: var(--size-spacing-04);
  color: var(--neutral-text-low-emphasis);
  ...
  ${e=>{let{second:t}=e;return t&&l.iv`
      margin-left: calc(var(--size-spacing-06) + 2 * ${R});
    `}}
`,M=(0,l.ZP)($.Z)`
  margin: 0;
  padding: 0;
...
`,L=(0,n.forwardRef)(((e,t)=>{let{locale:a=c.Z,...i}=e;const{monthsShown:o,date:l,decreaseMonth:s,increaseMonth:d,prevMonthButtonDisabled:f,nextMonthButtonDisabled:b,titleAction:y}=i,w=!P.Z(y)&&{forwardedAs:"div",tabindex:"-1"},Z=Array(o).fill(0);let x=document.getElementsByClassName("react-datepicker__month"),R=l;if(o>1&&x.length){const e=x[0].getAttribute("aria-label").replace("month","").trim().split("-").join("/");R=new Date(`${e}/01`)}return n.createElement(N,(0,r.Z)({ref:t},i),n.createElement(S,null,n.createElement(D,{kind:m.Z.kinds.tertiary,onClick:s,disabled:f,"aria-controls":"headerNavigation"},n.createElement(g.Z,{id:"previous-month",title:"go to previous month",titleId:"previous-month"})),n.createElement(T.Z,{id:"headerNavigation","aria-live":"assertive"},Z.map(((e,t)=>n.createElement(A,(0,r.Z)({key:`header-${t}`,second:!!t,token:p.Z.tokens.TEXT_MD_BOLD,onClick:y,kind:h.Z.kinds.tertiary,size:h.Z.sizes.md},w),`${(0,I.G4)(a)[(0,E.default)((0,_.default)(R,t))]} ${(0,u.default)(R)}`)))),n.createElement(D,{kind:m.Z.kinds.tertiary,onClick:d,disabled:b,"aria-controls":"headerNavigation"},n.createElement(v.Z,{id:"next-month",title:"go to next month",titleId:"next-month"}))),n.createElement(S,null,Z.map(((e,t)=>n.createElement(M,{as:$.Z.as.ul,key:`weekdays-${t}`},((e,t)=>{const a=(0,k.default)(t,{locale:e});return[].concat([0,1,2,3,4,5,6].map((t=>{const r=(0,z.default)(a,t),i=e.localize.day((0,C.default)(r),{width:"short"});return n.createElement("li",{key:t,className:"react-datepicker__day-name"},i)})))})(a,(0,_.default)(R,t)))))))}));L.displayName="DatePicker.MonthlyHeader",L.propTypes={locale:o().object,titleAction:o().func};const O=L,j="40px",F=l.ZP.div`
