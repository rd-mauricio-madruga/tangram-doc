...
`,w=(0,l.ZP)(p.Z)`
  ...
  left: 0;
  width: 280px;
`,Z=(0,n.forwardRef)(((e,t)=>{let{locale:a=c.Z,...i}=e;const{date:o,changeYear:l}=i;let s=o;return n.createElement(f,(0,r.Z)({ref:t},i),n.createElement(b,null,n.createElement(y,{kind:m.Z.kinds.tertiary,size:h.Z.sizes.sm,onClick:()=>l((0,u.default)(s)-1),"aria-controls":"headerNavigation"},n.createElement(g.Z,{id:"previous-year",title:"go to previous year",titleId:"previous-year"})),n.createElement(w,{id:"headerNavigation","aria-live":"assertive"},(0,u.default)(s)),n.createElement(y,{kind:m.Z.kinds.tertiary,size:h.Z.sizes.sm,onClick:()=>l((0,u.default)(s)+1),"aria-controls":"headerNavigation"},n.createElement(v.Z,{id:"next-year",title:"go to next year",titleId:"next-year"}))))}));Z.displayName="DatePicker.YearlyHeader",Z.propTypes={locale:o().object};const k=Z;var x=a(54571),z=a(64083),_=a(87926),E=a(37811),C=a(17752),$=a(5662),P=a(50046),T=a(38095),I=a(2793);const N="48px",R=l.ZP.div`
  display: flex;
  justify-content: space-between;
  position: absolute;
  width: calc(100% - (var(--size-spacing-04) * 2));
